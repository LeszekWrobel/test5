                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="text-muted">Dodano : {{$post->created_at}}</p>
                                    <p Ostatnia aktualizacja : {{$post->updated_at}}</small></p>

                                    <div class="row">
                                        <div class="col-6 my-2">
                                             <a href="posts/{{$post->id}}" class="btn btn-outline-dark btn-sm shadow p-1 mb-6  ">
                                                Zobacz szczegóły
                                             </a>
                                        </div>
